...
public class Info {
	...
	private void initialize() {
		...
		Label label = new Label("Entwickelt von Christopher Kochaneck - 2020 \u00A9");
		...
		JLabel lblNewLabel = new JLabel("Programm Work in Progress.");
		lblNewLabel.setForeground(Color.WHITE);
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setBounds(20, 115, 414, 14);
		frame.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Hinweise zu den Buttons werden unter dem Steuerpanel angezeigt.");
